<?php
    ...
    class ClienteCondicionComercialDataService{
         ...
         * @throws ORMException
         */
        public function data(int $id): ClienteCondicionComercial{
            ...
            $this->accesoService->create('ClienteCondicionComercial', $id, 4, $data);
