<?php
    ...
    class Configuraci_nNotificaci_onDataService{
         ...
         * @throws ORMException
         */
        public function data(int $id): Configuraci_nNotificaci_on{
            ...
            $this->accesoService->create('Configuraci_nNotificaci_on', $id, 4, $data);
