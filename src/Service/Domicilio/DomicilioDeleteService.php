<?php
    ...
    class DomicilioDeleteService{
         ...
         * @throws ORMException
         */
        public function delete(int $id): Domicilio{
            ...
            $this->repository->removeEntity($Domicilio);

            $this->accesoService->create('Domicilio', $id, 3, $data);
