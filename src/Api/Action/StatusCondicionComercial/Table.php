<?php
    ...
    use App\Model\StatusCondicionComercialModel;
    ...
    class Table{
        ...
        private StatusCondicionComercialModel $model;
    
        public function __construct(Datatable $datatable, StatusCondicionComercialModel $model){
