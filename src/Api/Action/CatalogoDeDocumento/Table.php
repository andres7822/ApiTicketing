<?php
    ...
    use App\Model\CatalogoDeDocumentoModel;
    ...
    class Table{
        ...
        private CatalogoDeDocumentoModel $model;
    
        public function __construct(Datatable $datatable, CatalogoDeDocumentoModel $model){
