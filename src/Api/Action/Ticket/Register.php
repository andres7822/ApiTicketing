<?php
    ...
    use App\Service\Ticket\TicketRegisterService;
    ...
    class Register{
        ...
        public function __construct(TicketRegisterService $service){
        ...
        public function __invoke(Request $request): Ticket{
            ...
            return $this->service->create($Folio, $FechaYHora, $Tema, $Descripcion, $Solicitante, $Sucursal, $Area, $FechaCompromiso, $Observaciones, $Status, $Tipo, $Involucrados);
        }
    }