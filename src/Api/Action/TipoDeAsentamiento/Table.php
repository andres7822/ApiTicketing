<?php
    ...
    use App\Model\TipoDeAsentamientoModel;
    ...
    class Table{
        ...
        private TipoDeAsentamientoModel $model;
    
        public function __construct(Datatable $datatable, TipoDeAsentamientoModel $model){
