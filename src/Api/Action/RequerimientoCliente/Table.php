<?php
    ...
    use App\Model\RequerimientoClienteModel;
    ...
    class Table{
        ...
        private RequerimientoClienteModel $model;
    
        public function __construct(Datatable $datatable, RequerimientoClienteModel $model){
