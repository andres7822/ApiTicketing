<?php
    ...
    use App\Service\Domicilio\DomicilioRegisterService;
    ...
    class Register{
        private DomicilioRegisterService $service;

        public function __construct(DomicilioRegisterService $service){
         ...
         * @throws ORMException
         */
        public function __invoke(Request $request): Domicilio{
            ...
            return $this->service->create($TipoDeVialidad, $Vialidad, $TipoDeAsentamiento, $Asentamiento, $NumeroExterior, $NumeroInterior, $Pais, $EntidadFederativa, $Municipio, $Localidad, $CodigoPostal, $Latitud, $Longitud, $GooglePin, $Visible, $Actual, $FechaTupla, $Origen, $Tupla);
        }
    }